...
class GigWatchTest(GigTestBase):
    ...
    def test_watch_email_prepare(self):
        class band_obj:
            name = None
            def __str__(self):
                return self.name
        ...
        plan111 = plan_obj()
        plan111.gig = gig11
        plan111.name = 'plan111'
        plan112 = plan_obj()
        plan112.gig = gig11
        plan112.name = 'plan112'
        gig12 = gig_obj()
        gig12.band = band1
        gig12.name = 'gig12'
        plan121 = plan_obj()
        plan121.gig = gig12
        plan121.name = 'plan121'
        plan122 = plan_obj()
        plan122.gig = gig12
        plan122.name = 'plan122'
        ...
        plan211 = plan_obj()
        plan211.gig = gig21
        plan211.name = 'plan211'
        plan212 = plan_obj()
        plan212.gig = gig21
        plan212.name = 'plan212'
        gig22 = gig_obj()
        gig22.band = band2
        gig22.name = 'gig22'
        plan221 = plan_obj()
        plan221.gig = gig22
        plan221.name = 'plan221'
        plan222 = plan_obj()
        plan222.gig = gig22
        plan222.name = 'plan222'

        plans = [
            plan111, plan112, plan121, plan122, plan221, plan222, plan211, plan212,
        ]

        answer = _prepare_plans_for_watcher_email(plans)
